            ...
            >
              ...
              <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>
                  Check your email inbox for a message. Enter the one-time password
                  (OTP) you recieved below to continue resetting your password.
                </Text>
              </View>
              ...
              <View style={styles.resendRow}>
                {!canResend && (
                  <Text style={styles.resendInfo}>
                    You can ask to resend the code in{" "}
